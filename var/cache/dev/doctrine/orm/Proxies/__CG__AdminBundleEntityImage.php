 ...
 */
class Image extends \AdminBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AdminBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'AdminBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'AdminBundle\\Entity\\Image' . "\0" . 'alt');
        }
