...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'acme_demo.form.task' => 'getAcmeDemo_Form_TaskService',
            'acme_demo.form.type.task' => 'getAcmeDemo_Form_Type_TaskService',
    ...
    /**
     * Gets the 'acme_demo.form.task' service.
     *
     ...
     */
    protected function getAcmeDemo_Form_TaskService()
    {
        return $this->services['acme_demo.form.task'] = new \Symfony\Component\Form\Form('task_form', 'task', NULL, array('validation_groups' => array(0 => 'Default')));
    }

    /**
     * Gets the 'acme_demo.form.type.task' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AsnaBundle\AdvertController A AsnaBundle\AdvertController instance.
     */
    protected function getAcmeDemo_Form_Type_TaskService()
    {
        return $this->services['acme_demo.form.type.task'] = new \AsnaBundle\AdvertController();
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_f7a7c55b373adf98e5eac4b01f3b696fe5b9081ef7dfa4e9690fc906cc9e7698');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('webmaster', 'Fablab');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('292517a40178aab5cfb9db3d3698e13a3dddac30');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56b8aa27881cb6.96398285')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '292517a40178aab5cfb9db3d3698e13a3dddac30',
            'app_webmaster' => 'Fablab',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '292517a40178aab5cfb9db3d3698e13a3dddac30',
